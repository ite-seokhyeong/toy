...
public class SimpleProjApplication {
	...
	public static void main(String[] args) {
		logger.info("SpringBoot main() - ", SimpleProjApplication.class.getSimpleName());

		new SpringApplicationBuilder(SimpleProjApplication.class).initializers(new WebServerConfig()).run();
